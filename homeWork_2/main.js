...
//a *= 2 Это сокращенная запись просвоения a=a*2, соответсвенно в скобках получаем 2*2=4  и прибавляем +1. Ответ x=5
...
let val = +prompt( "задайте число возодимое в степень");
let pow = +prompt("Зайдайте степень в которую нужно возвести это число");

power(val, pow);

alert("итоговое число равно " + power(val, pow));
